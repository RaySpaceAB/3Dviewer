...
function menuController( $scope, $interval, $sce, $window, $timeout, $location, $anchorScroll, $http, $q, $element, _, WPservice, SketchfabService) {
        ...
        // use the home path as argument to send postrequest
        _init(ctrl.homeURL);
        ...
        function initModels(i){
            ...
            ctrl.currentTitle = _sweAnnotTitle[0];
        ...
        function _scrollTo(selectedModelIndex){
            console.log("_cameraPositions: ", _cameraPositions[_currentModel][_currentAnnotation]);
            ...
            if(ctrl.selected !== selectedModelIndex){
                ...
                //set the annotation index to default
        ...
        function _nextAnnotation(){
            ...
            //console.log("Cam pos: ", _cameraPositions[_currentModel][_currentAnnotation]);
            if(hasAnnotation(_cameraPositions[_currentModel][0])){
        ...
        function setDefaultAnnotation(index){
            console.log("_viewers[index].cameraPosition: ", _viewers[index].cameraPosition);
        ...
        function hasAnnotation(position){
            ...
            return ((_cameraPositions[_currentModel].length > 0) ? true : false);
        }
