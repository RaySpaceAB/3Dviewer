...
function load_scripts() {
	...
	wp_enqueue_script('interface', THEME_DIR_URI . '/js/Interface.js', array( 'angularjs', 'angularjs-route' ));
	wp_enqueue_script('theme-service', THEME_DIR_URI . '/js/WPservices.js');
	wp_enqueue_script('model-handler', THEME_DIR_URI . '/js/ModelHandler.js');
